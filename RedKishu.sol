 ...
 * $REDKISHU  
 * 
 * Telegram : t.me/REDKISHU
 * Website :  RedKishu.com
 * 
 * $REDKISHU is made to be fully transferred to its beloved community.
 * 
 * $REDKISHU community is completely organic and will work hard as a community to make each member crypto-rich.
 * 
 * 60% of total supply and 5 BNB was added as initial liquidity to PancakeSwap.
 * 
 ...
 * 
 * ( Marketing wallet is transparent and used only for the development and marketing of the project for the benefit and growth of the $REDKISHU community )
 * 
 * 
 * Total Supply  |  100 Quadrillion
 * 60% Liquidity Pool ( Fair & Locked 🔓 )
 * 25% Initial Liquidity Providers PS
 * 10% Reserved to be manually burned at celebratory milestones
 * 5%  Team 
 * 
 * 
 * ( Marketing Wallet: 0x6C0D1497656f5E102289d46072a39D11d44c741F )
 * ( Team Wallet: 0x912FD295566A27dA3887b466dAF77a4C031Cc403 )
 * ( Manual Burn Wallet: 0x20d19261941f7b232c224dad2f33018a42b8df5a )
 * 
 * 
 * 0.1% Limitation for each trade ( Buy & Sell ) -- at the fair launch event
 * Max Tx Amount    : 0.1% --  100.000.000.000.000 --  100 Trillion
 * 
 * In the sequel
 * Max Tx Amount    : 1% --  1.000.000.000.000.000 --  1 Quadrillion
 *  
 * Max Wallet Size  : 2% -- 2.000.000.000.000.000  --  2 Quadrillion
 * 
 * 
 * 
 * We are not affiliated with any other groups, projects or teams. We are the original $REDKISHU team.
...
contract REDKISHU is Context, IERC20, Ownable {
    ...
    string private _name = "REDKISHU";
    string private _symbol = "REDKISHU";
    ...
    address public marketingWallet = 0x6C0D1497656f5E102289d46072a39D11d44c741F;
    ...
    uint256 public _maxTxAmount = 100000000 * 10**6 * 10**9; // 0.1%  //  
    uint256 public _maxWalletSize = 2000000000 * 10**6 * 10**9; // 2%  // 
    uint256 private numTokensSellToAddToLiquidity = 100000000 * 10**6 * 10**9; // 0.1%  // 
